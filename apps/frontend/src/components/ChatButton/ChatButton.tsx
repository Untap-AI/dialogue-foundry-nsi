  ...
  return (
    <>
      <Button
        ...
        size="icon"
        className={cn(
          "w-[60px] h-[60px] rounded-full shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl active:scale-95",
          "bg-primary text-primary-foreground border-none p-0 m-0"
        )}
        onClick={onClick}
        aria-label={isOpen ? 'Close chat' : 'Open chat'}
      >
        {/* Icon */}
        <svg viewBox="0 0 24 24" className="!w-[30px] !h-[30px] fill-primary-foreground">
