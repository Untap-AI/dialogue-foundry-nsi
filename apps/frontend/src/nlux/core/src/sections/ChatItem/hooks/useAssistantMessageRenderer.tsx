...
import type { ResponseRendererProps } from '../../../exports/messageOptions'
...
export const useAssistantMessageRenderer = function <AiMsg>(
  ...
  if (messageOptions?.responseRenderer !== undefined) {
    ...
    if (dataTransferMode === 'stream') {
      ...
      return () => {
        const Comp = messageOptions.responseRenderer as FC<
          ResponseRendererProps<AiMsg>
        >
        return <Comp {...props} />
      }
    }
