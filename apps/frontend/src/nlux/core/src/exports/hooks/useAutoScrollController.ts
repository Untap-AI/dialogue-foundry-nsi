...
export const useAutoScrollController = (
  ...
  const [autoScrollController, setAutoScrollController] =
    useState<AutoScrollController>()
  const [conversationContainer, setConversationContainer] =
  ...
  useEffect(() => {
    const currentConversationContainer =
      conversationContainerRef.current || undefined
  ...
  useEffect(() => {
    ...
    if (autoScrollControllerRef.current) {
      autoScrollControllerRef.current.updateConversationContainer(
