import type { MessageOptions as JavaScriptMessageOptions } from '@nlux/core'
 ...
 */
export type MessageOptions<AiMsg = string> = Omit<
  JavaScriptMessageOptions<AiMsg>,
  'responseRenderer' | 'promptRenderer'
> &
