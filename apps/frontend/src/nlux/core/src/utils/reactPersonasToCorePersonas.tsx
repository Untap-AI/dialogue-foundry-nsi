...
import type { PersonaOptions } from '@nlux/core'
import type { JSX } from 'react'
import type { PersonaOptions as ReactPersonasOptions } from '../exports/personaOptions'
...
export const reactPersonasToCorePersonas = async (
  reactPersonas: ReactPersonasOptions
  ...
  const [assistant, user] = await Promise.all([
    (async () => {
      ...
      const assistantAvatar =
        typeof reactPersonas.assistant.avatar === 'string'
    ...
    (async () => {
      ...
      const userAvatar =
        typeof reactPersonas.user.avatar === 'string'
